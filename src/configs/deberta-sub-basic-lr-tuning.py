...
class Config:
    experiment_name = "deberta-sub-basic-lr-tuning"
    model_name = "microsoft/deberta-v3-base"
    params_checked = "add_context"
    log_n_error_samples: int = 10
    ...
    eval_every_n_batches: int = 99999999
    gradient_accumulation_steps: int = 4

    encoder_lr: float = 5e-6
    fc_lr: float = 5e-6
    encoder_weight_decay: float = 0.001
    freeze_layers: int = 0
